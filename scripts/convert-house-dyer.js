...
const outDir = path.join(__dirname, '..', 'images', 'webp', 'ecological-design');
...
const conversions = [
  { input: 'house dyer (3).jpg', baseName: 'house-dyer-george-3' },
  { input: 'house dyer (4).jpg', baseName: 'house-dyer-george-4' },
  { input: 'house dyer (5).jpg', baseName: 'house-dyer-george-5' },
  { input: 'house dyer (6).jpg', baseName: 'house-dyer-george-6' },
];
